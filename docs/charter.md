...
| 4 | Magic | ✅ Complete | v0.4.1–0.4.2. Ars Nouveau 5.12.1 + Patchouli + GeckoLib as deps. Ars Delight (FD compat) added. Sodium Dynamic Lights and Create: Dynamic Lights removed — Ars Nouveau bundles lambdynlights-api 4.5.1 as a JAR-in-JAR dep, causing a module conflict with both mods; no workaround found. 137 mods total. |
