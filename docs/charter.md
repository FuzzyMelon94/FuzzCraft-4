...
| 6 | Dimensions | ✅ Complete | v0.6.1. Twilight Forest (CF) + Twilight Delight, The Aether + Deep Aether + Aether Villages + Explore Ruins: The Aether + Aether's Delight (beta ⚠️), Deeper and Darker, The Bumblezone, Dimensional Dungeons, Dimensional Pockets II, Lootr. Deps: owo-lib, Cosmos Library. Fixed: Create: CC Total Logistics, Threaded Trains, and Oxidized incorrectly marked server-only (missing in SP). Aether: Lost Content Addon still no 1.21.1 build — watchlisted. 199 mods total. SP testing clean. Multiplayer testing deferred to post-final-batch group session. |
