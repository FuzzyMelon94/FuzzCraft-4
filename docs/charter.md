...
| 4 | Magic | 🔄 In Progress | v0.4.1. Ars Nouveau 5.12.1 + Patchouli + GeckoLib as deps. Ars Delight (FD compat) added. 138 mods total — over 120 soft cap, monitor as later batches add more. |
